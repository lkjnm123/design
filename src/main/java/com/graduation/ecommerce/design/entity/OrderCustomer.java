...
public class OrderCustomer {
    private int order_customer_id; //自增主键
    private int order_item_id; //外键
    private int customer_id; //取消外键关联
    private int shop_id; //取消外键关联
    private int good_id; //取消外键关联  取消无用外键关联
    ...
    public OrderCustomer(int order_customer_id, int order_item_id, int customer_id, int shop_id, int good_id, int good_number, String address_context, String order_number, int good_status, String express_number) {
